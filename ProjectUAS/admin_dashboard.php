...
// Status diurutkan sesuai urutan yang diinginkan di chart
$status_counts = [
...
// === PERUBAHAN DI SINI: MENYIAPKAN DATA UNTUK CHART ===
// 1. Siapkan label dan value untuk chart status
$status_labels = array_keys($status_counts);
$status_values = array_values($status_counts);

// 2. Tambahkan data "Total Pendaftar" ke awal array agar muncul di chart
array_unshift($status_labels, "Total Pendaftar");
array_unshift($status_values, $total_pendaftar);

// 3. Konversi ke format JSON untuk dikirim ke HTML
    ...
    <div class="content-wrapper" style="max-width: 1200px;">
        ...
        <div class="dashboard-grid">
            ...
            <div class="stat-card" style="border-left-color: var(--warning-color);">
                <h3>Berkas Tidak Lengkap</h3>
                <p><?= $status_counts['Berkas Tidak Lengkap'] ?></p>
            </div>
