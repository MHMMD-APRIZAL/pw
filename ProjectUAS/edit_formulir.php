...
<div class="content-wrapper">
    ...
    <a href="dashboard.php" class="button-secondary">⬅️ Kembali ke Dashboard</a>
    </div>
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="profile-picture-container" style="text-align: center; margin-bottom: 20px;">
            ...
            $imageUrl = !empty($profile['foto_url']) 
                        ? htmlspecialchars($profile['foto_url']) 
                        : 'assets/img/default-avatar.png'; 
            ?>
            
            <img id="profilePicturePreview" src="<?= $imageUrl ?>" alt="Preview Foto Profil">

        </div>

        <label for="foto_profil_input">Ubah Foto Profil (Kosongkan jika tidak ingin mengubah)</label>
        <input type="file" id="foto_profil_input" name="foto_profil" accept="image/jpeg, image/png">
        <br><br>
        <hr>
